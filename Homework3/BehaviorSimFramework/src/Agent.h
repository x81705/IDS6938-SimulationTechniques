// Agent.h: interface for the SIMAgent class.
//
//////////////////////////////////////////////////////////////////////
...
#ifndef BEHAVIORTYPE
#define BEHAVIORTYPE
enum BehavoirType{SEEK, FLEE, ARRIVAL, DEPARTURE, WANDER, AVOID, SEPARATION, ALIGNMENT, COHESION, FLOCKING, LEADER};
#endif
...
//Member functions:
	...
	virtual ~SIMAgent();
	//Constructor
	SIMAgent(float* color, CEnvironment* env);
	//Initiate the states
