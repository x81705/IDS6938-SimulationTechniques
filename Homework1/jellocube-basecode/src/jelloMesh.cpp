	...
	JelloMesh::Intersection& result)
{
    ...
    // Alex helped with figuring out point intersections, and how to introduce point variables, dist, normals for this

	//double time = (cylinderStart - point) * Dot(cylinderStart, -cylinderAxis) / (cylinderAxis * cylinderAxis);
