...
int main()
{
	...
	//std::uniform_real_distribution<> dist(-1, 1);  // example of a uniform distribution
	//std::normal_distribution<> dist(-1, 1);    // example of a normal distribution, was at 50 and 100
	//std::uniform_int_distribution<> dist(-1, 1); // Test to see difference between real and int
